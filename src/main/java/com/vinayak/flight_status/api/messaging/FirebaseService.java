    ...
    public void sendFlightStatus(NotificationType notificationType,
        ...
        try {
            ...
            if(notificationType == NotificationType.SFLIGHT){
                String body = "";
                switch (flightStatus) {
                    case ON_TIME -> body = "YAHO! Flight on time. Don't forget to leave on time.";
                    case DELAYED -> body = "WAAAIT! Flight got delayed. Please check updated time before leaving.";
                    case CANCELLED -> body = "NOOO! Flight got cancelled. Don't worry this is on us. You can rebook if you want or get full refund.";
                    default -> {
                    }
                }
